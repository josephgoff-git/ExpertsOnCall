...
function adjustNav2() {
    // if (window.innerWidth >= 1000) {
        ...
        // navRight.insertBefore(bagIcon, navRight.firstChild);
        // navRight.insertBefore(searchIcon, navRight.firstChild);
        
        // bagIcon.style.marginLeft = "10px"
    ...
    // } else {
        ...
        searchIcon.remove()
        bagIcon.remove()
        bagIcon.style.marginRight = "15px"
        accountIcon.style.marginLeft = "10px"
...
function displayDropdown(item) {
    for (i=1; i<7; i++) { 
        if (item.id === "nav-center-a" + i || item.id === "dropdown-item" + i) {
            ...
            dropdownItem.style.borderBottom = "1px solid rgb(63, 63, 206, 0.3)"
            navAItem.style.paddingBottom = "35px"
            navPItem.style.borderBottom = "2px solid rgb(14, 84, 150)"
